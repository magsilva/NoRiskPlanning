...
if (Validate_Session($complete_sess_id, $_SERVER['REMOTE_ADDR'], $bd))
{
	...
	{
		case 'day':{
			$result_xsl = "xsl/" . $default_xsl . "/groups_members_shedule_day.xsl";
		}break;
		case 'week':{
			$result_xsl = "xsl/" . $default_xsl . "/groups_members_schedule_week.xsl";
		}break;
	}
	...
	$apps = Retrieve_Appointments_Groups($group_id, $beg_day, $end_day, '', '',
		$cfg['time'], $cfg['user_type'], $cfg['user_color'], $cfg['user_icon'], $cfg['days'], 0, $bd);
}
else
{
