...
if (Validate_Session($complete_sess_id, $_SERVER['REMOTE_ADDR'], $bd))
{
	...
	// If the submit button to confirm the appointment deletion was pressed
	{
		...
		{
			if (Delete_Room($_POST['account_id'], $bd) == 1)
			{
				$alert[$num_alerts++] = 'Room deleted successfully';
			}
		}
		else
		{
			$alert[$num_alerts++] = 'Room deletion cancelled';
		}
	...
	$result_xsl = "xsl/" . $default_xsl . "/adm_acc_rooms_remove.xsl";
}
else
{
