...
if (Validate_Session($complete_sess_id, $_SERVER['REMOTE_ADDR'], $bd))
{
	...
	else
	{
		...
		switch($membership)
		{
			case 'O': $result_xsl = "xsl/" . $cfg['default_xsl'] . "/groups_documents_mod.xsl"; break;
			case 'M': $result_xsl = "xsl/" . $cfg['default_xsl'] . "/groups_documents_mod.xsl"; break;
			case 'C': $result_xsl = "xsl/" . $cfg['default_xsl'] . "/groups_documents.xsl"; break;
		}
	}
	...
	$documents = List_Documents($group_id, '', $cfg, $bd);
}
else
{
