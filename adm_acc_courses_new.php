...
if (Validate_Session($complete_sess_id, $_SERVER['REMOTE_ADDR'], $bd))
{
	...
	// If the submit button to create the unit was pressed
	{
		...
		switch (User_Validate_Simple_Field($courses[0][0], 32))
		{
			...
			case 1:{
				$current = Check_Account_Id($courses[0][0], $bd);
				if ($current || ($courses[0][0] == 'admin'))
		...
		if (empty($error))
		{
			...
			Insert_Course($courses[0][0], $courses[0][1], $courses[0][2], $courses[0][3],
