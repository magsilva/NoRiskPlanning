...
<tr>
	...
	<td class="al_center">
		<a>
			<xsl:attribute name="href">
				groups_documents_remove.php?sess_id=<xsl:value-of select="$session_id"/>&amp;document_id=<xsl:value-of select="@id"/>&amp;group_id=<xsl:value-of select="/nrp/group/@id"/>
			</xsl:attribute>
			<img src="images/button_drop.png" border="0">
				<xsl:attribute name="alt">
					Remove Document <xsl:value-of select="@id"/>
				</xsl:attribute>
			</img>
		</a>
	</td>
