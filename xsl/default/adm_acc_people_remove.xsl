...
<form action="adm_acc_people_remove.php" method="POST">
<p class="big_head">
Are you sure you want to delete the Person
"<xsl:value-of select="/nrp/person/person.name"/>" and all information linked to this person?
</p>
