...
<div class="location">
	...
	<xsl:attribute name="href">
     ...
     Departments</a> / Modify Department
</div>
...
<form action="adm_departments_modify.php" method="POST">
<table summary ="Department information" class="data">
<tr>
...
<br/><input type="submit" class="button" name="modify" value="Modify Department"/>
