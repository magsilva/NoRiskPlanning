...
<p class="big_head">
To insert a new document, fill in the document descriptions, choose the file, and press 'Insert':
</p>

<form action="groups_documents_new.php" method="post" enctype="multipart/form-data">
<label for="description">Description: </label>
<input type="text" name="description" siz2="40"/><br/><br />
