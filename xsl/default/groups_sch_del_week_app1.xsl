...
<xsl:value-of select="/nrp/schedule/appointment/appointment.group"/></a> / Schedule Group Appointment / Delete weekly appointment
</div>
...
<form action="groups_sch_del_week_app.php" method="POST">
<p class="big_head">
Are you sure you want to delete the group appointment
