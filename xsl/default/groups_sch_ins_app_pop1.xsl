...
One of the members has weekly appointments scheduled within the informed time span. <br />Are you sure
you want to schedule the appointment "<xsl:value-of select="/nrp/schedule/appointment/appointment.description"/>" ?
</p>
<p>
