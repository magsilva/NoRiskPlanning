...
<form action="adm_acc_people_new.php" method="POST">
<table summary ="New Person information" class="data">
<tr>
...
<tr>
	<th align="left"><label for="url">URL: </label><br/> (optional)</th>
	<td align="left">
...
<br/><input type="submit" class="button" name="create" value="Create New Person"/>
