...
<xsl:value-of select="/nrp/group/group.name"/></a> / Remove a member
</div>
...
<xsl:value-of select="/nrp/group/group.member/group.member.name"/> from the group, as soon as all information
linked to him/her?
</p>


<form action="groups_members_remove.php" method="post">
<p class="big_head">
