...
<form action="adm_acc_rooms_modify.php" method="POST">
<table summary ="Room information" class="data">
<tr>
...
<br/><input type="submit" class="button" name="modify" value="Modify Room"/>
