...
<form action="adm_acc_courses_new.php" method="POST">
<table summary ="New Course information" class="data">
<tr>
...
<tr>
	...
	<td align="left">
		<textarea name="comments" rows="3" cols="40">
			<xsl:value-of select="/nrp/courses/courses.comments"/>
		</textarea>
	</td>
</tr>
</table>
...
<br/><input type="submit" class="button" name="create" value="Create New Course"/>
