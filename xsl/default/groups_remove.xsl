...
<p class="big_head">
Are you sure you want to remove the group <xsl:value-of select="/nrp/group/group.name"/>, all
the notices, documents, members, and appointments related to it?
</p>


<form action="groups_remove.php" method="post">
<p class="big_head">
