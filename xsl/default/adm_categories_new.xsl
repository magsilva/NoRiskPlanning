...
<div class="location">
	...
	<xsl:attribute name="href">
     ...
     Categories</a> / Create New Category
</div>
...
<form action="adm_categories_new.php" method="POST">
<table summary ="New Category information" class="data">
<tr>
...
<br/><input type="submit" class="button" name="create" value="Create New Category"/>
